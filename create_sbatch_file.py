...
def get_args():
    ...
    parser.add_argument('--series_name', type=str, default='series_A')
...
if __name__ == "__main__":
    ...
    python_file_name = '/home-nfs/yangc1/speech/main.py'
    root = '/home-nfs/yangc1/speech/shell_script/asr/' + str(args.id)
    if not os.path.exists(root):
        os.makedirs(root)
    shell_script_name = root + '/job'
    file_name = root + '/asr_' + str(args.id) + '.sh'
